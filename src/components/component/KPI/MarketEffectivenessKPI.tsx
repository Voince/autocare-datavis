    ...
    return (
        <Card>
            <CardHeader className="pb-2">
                ...
                <CardTitle className="text-6xl">{averageRating.toFixed(1)}</CardTitle>
            </CardHeader>
            <CardContent>
    ...
    return (
        <Card>
            <CardHeader className="pb-2">
                ...
                <CardTitle className="text-6xl">{averageCompletionDays.toFixed(1)} days</CardTitle>
            </CardHeader>
            <CardContent>
    ...
    return (
        <Card>
            <CardHeader className="pb-2">
                ...
                <CardTitle className="text-6xl">{mostEffectiveSource}</CardTitle>
            </CardHeader>
            <CardContent>
